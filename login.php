...
<body>
	...
	<div class="container-login100" style="background-image: url('images/web-design1.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-30">
        
			<h6 style="margin-left:100%"><a href="index.php" class="txt2 hov1"><span><i class="fa fa-times"></i></span></a></h6>
			...
			<div class="container-login100-form-btn">
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter password">
					<input class="input100" type="password" id="pass" name="pass" placeholder="password" pattern="[a-zA-Z0-9]+" minlength="3" required>
                    <span class="focus-input100"></span>
				...
				<div class="text-center">
					<h3><b><a href="reg.php" class="txt2 hov1">Sign Up</a></b></h3>
				</div>
				<div class="text-center">
					<h6><a href="forgot.php" class="txt2 hov1">Forgot password!</a></h6>
				</div>
			</form>
