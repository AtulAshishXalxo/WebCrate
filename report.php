...
session_start();
  ...
  foreach($rows as $row)
  {
    ...
    ?>
    <a href="./NiceAdmin/dashboard.php?name=<?php echo $name;?>&mail=<?php echo $mail;?>&info=<?php echo $info;?>&dev_mail=<?php echo $dev_mail;?>" type="button" class="btn btn-secondary ml-5 float-right"  >Back</a>
    ...
    <div class="row" style="margin-top:50px">
      ...
      <?php 
                    ...
                    {?>
                      ...
                      Developer Fee : <?php echo  $row->fee;?></br>
