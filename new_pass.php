...
<body>
	...
	<div class="container-login100" style="background-image: url('images/webdesign-photo.jpg');background-repeat:no-repeat">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-30">
			...
			<div class="container-login100-form-btn">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="new password">
					<input class="input100" type="password" id="new_pass" name="new_pass" placeholder="new password" pattern="[a-zA-Z0-9]+" minlength="3" required>
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "confirm password">
					<input class="input100" type="password" id="c_pass" name="c_pass" placeholder="confirm password" pattern="[a-zA-Z0-9]+" minlength="3" required>
                    <span class="focus-input100"></span>
...
if(isset($_POST['go'])) 
{
    ...
    { 
                ...
                foreach($rows as $row)
                {
                               ...
                               if($result = $mongo->executeBulkWrite('WebCrate.users', $bulk))
                               {
               ...
               echo $email;
                ...
                foreach($rows as $row)
                {
                                ...
                                if($result = $mongo->executeBulkWrite('WebCrate.admins', $bulk))
                                {
                                    //$_SESSION['user_session']=$user;
