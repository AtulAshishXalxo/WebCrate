...
<body >
	...
	<div class="container-login100" style="background-image:url('images/web-designing-tips.jpg');height:100%;width:75%;background-repeat:no-repeat">
		<div class="row" >
			<div class="col-11" >
			...
			<div class="col-1 " >
							<div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-30" style="box-shadow:2px 1px 10px 1px blue;">
							<form class="login100-form validate-form" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" onClick="validation()">
									...
									<div class="text-center">
										<h6><a href="login.php" class="txt2 hov1">Back</a></h6>
									</div>
